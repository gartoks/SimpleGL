...
using static SimpleGL.Audio.AudioFile;

namespace SimpleGL.Audio;
/// <summary>
...
internal static class AudioManager {
    ...
    /// </summary>
    /// <param name="v">Volume value. Must be in [0, 1]</param>
    internal static void SetSoundVolume(float v) {
        //SoundActionQueue.Add(() => {  // TODO test if works without
    ...
    /// </summary>
    /// <param name="v">Volume value. Must be in [0, 1]</param>
    internal static void SetMusicVolume(float v) {
        //MusicActionQueue.Add(() => {  // TODO test if works without
